...
extern "C"
{
    ...
    bool isBlacklisted(IDXGIAdapter1 *hardwareAdapter)
    {
        ...
        fwprintf(stderr, L"Selected: %s.\n", currentAdapterName.c_str());
        return false;
    }

    bool defineHardwareAdapter(IDXGIFactory4 *pFactory, IDXGIAdapter1 **ppAdapter)
    {
        fprintf(stderr, "define adapters\n");
        *ppAdapter = nullptr;
    ...
    {
        fprintf(stderr, "create dx12 device\n");
        ...
        JNIEnv *env, jobject redrawer, jlong devicePtr, jlong contextPtr, jint width, jint height, jint index)
    {
        ...
        // return toJavaPointer(SkSurface::MakeFromBackendRenderTarget(
        //                          context, backendRT, kTopLeft_GrSurfaceOrigin,
        //                          kRGBA_8888_SkColorType, SkColorSpace::MakeSRGB(), &surfaceProps)
        //                          .release());
    }
